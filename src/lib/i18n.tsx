...
const dict = {
  ar: {
    ...
    helpers: 'المساعدون في إنشاء التطبيق',
    helperName: 'الاسم',
    helperPhone: 'رقم الهاتف',
    addHelper: 'إضافة مساعد',
    ...
    confirmBulkDelete: 'سيتم حذف {n} كتاب نهائياً. هل أنت متأكد؟',
    actions: 'إجراءات',
    name: 'الاسم',
    ...
    requested: 'مطلوب',
    borrowed: 'مُعار',
    currentlyBorrowed: 'هذا الكتاب مُعار حالياً',
    borrowedBy: 'مُعار لـ',
    reserved: 'محجوز',
    lost: 'مفقود',
    damaged: 'تالف',
    ...
    selected: 'محدد',
    tncBody: `1. هذه المكتبة الإلكترونية لخدمة طلاب وخريجي مكتبة الامتياز.\n2. عند طلب استعارة، يجب إرجاع الكتاب في التاريخ المحدد.\n3. الكتب الإلكترونية للقراءة الشخصية فقط، يُمنع إعادة النشر.\n4. تحتفظ إدارة المكتبة بحق رفض أي طلب دون إبداء الأسباب.\n5. باستخدامك للتطبيق أنت توافق على هذه الشروط.`,
  ...
  en: {
    ...
    helpers: 'Helpers behind this app',
    helperName: 'Name',
    helperPhone: 'Phone number',
    ...
    confirmBulkDelete: '{n} books will be permanently deleted. Are you sure?',
    actions: 'Actions',
    name: 'Name',
    ...
    requested: 'Requested',
    borrowed: 'Borrowed',
    currentlyBorrowed: 'This book is currently borrowed',
    ...
    selected: 'selected',
    tncBody: `1. This digital library serves students and alumni of Makthabathul Imthiyaz.\n2. Borrowed books must be returned by the agreed date.\n3. Digital books are for personal reading only — redistribution is prohibited.\n4. The library reserves the right to refuse any request without explanation.\n5. By using this app you accept these terms.`,
    faqBody: `Q: How do I borrow a book?\nA: Open the book page and tap "Request to borrow".\n\nQ: How long is the borrow period?\nA: You choose when requesting — typically 7 to 14 days.\n\nQ: Can I read the book online?\nA: Yes — if the book text is available a "Read the book" button appears.\n\nQ: How do I contact the library?\nA: Use "Contact Us" inside Settings.`,
  },
} as const;
